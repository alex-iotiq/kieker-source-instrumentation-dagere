...
public class SelectiveSourceInstrumentationIT {
   ...
   public void testExecution() throws IOException {
      ...
      InstrumentationConfiguration kiekerConfiguration = new InstrumentationConfiguration(AllowedKiekerRecord.DURATION, true, true, false, includedPatterns, excluded, true, 1000, false, false);
